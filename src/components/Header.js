          ...
          <article className="flex items-center">
            ...
            {isOpen &&(
                <div className="absolute left-5 right-5  top-20 rounded bg-slate-900 text-slate-200 text-center py-10
                  md:relative md:top-0 md:left-0 md:right-0 md:bg-transparent md:text-slate-700 md:text-left md:py-0 md:flex md:items-center">
                 <nav flex items-start justify-start>
                  <ul>
                   <li>Features</li>
                   <li className="my-5 md:my-0">Pricing</li>
                   <li>Resources</li>
                   </ul>
                  </nav>
                  <ul>
                   <li className="my-5 md:my-0 md:mx-5">Login</li>
